...
import sevenimage from '../../img/projects/project39-franschhoekhugenotmuseum/franschhoekhugenotmuseum-2019-7.jpg';
import eightimage from '../../img/projects/project39-franschhoekhugenotmuseum/franschhoekhugenotmuseum-2019-8.jpg';

class ProjectThirtynineContent extends Component {
    render() {
        var settings = {
            dots: true,
            // infinite: true,
...
export default ProjectThirtynineContent;
